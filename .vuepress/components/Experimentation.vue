<template>
  <div class="experimentationWrap">
    <div class="card" v-for="(item) in DATA" :key="item.title">
      <div class="card-cover"></div>
      <div class="card-body">
        <div class="card-meta">
          <div class="card-meta-title">{{ item.title }}</div>
          <div class="card-meta-description" :title="item.description">{{ item.description }}</div>
        </div>
      </div>
...
<script>
import DATA from './experimentation.json'
...
.card {
  ...
  .card-cover {
    img {
      border-radius: @border-radis @border-radis 0 0;
    }
